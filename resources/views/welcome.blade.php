...
<body>
    <div class="container">
        ...
        <form id="loginForm">
            ...
            <button type="button" class="btn" id="openRegisterModal">Criar Conta</button>
            <button type="button" class="btn" id="openRecoveryModal">Esqueci a Senha</button>
        </form>
    </div>
    ...
    <div id="recoveryModal" class="modal">
        <div class="modal-content">
            ...
            <form>
                ...
                <input type="email" id="recoveryEmail" placeholder="Digite seu email">
                <button class="btn" type="button" onclick="recoverPassword()">Recuperar senha</button>
            </form>
            <p id="message"></p>
        </div>
    </div>
    <script>
        ...
        document.getElementById("openRecoveryModal").addEventListener("click", function () {
        ...
        function recoverPassword() {
            ...
            message.textContent = email ? "Um link de recuperação foi enviado." : "Digite um email válido.";
        }
    ...
    let formData = {
        ...
        password_confirmation: document.getElementById("confirmar_senha").value
    };
...
document.getElementById("loginForm").addEventListener("submit", async function (event) {
    ...
    try {
        ...
        alert(result.message);
        if (response.ok) {
            window.location.href = "/dashboard"; // Redireciona para a página principal após login bem-sucedido
        }
    } catch (error) {
...
function recoverPassword() {
    ...
    fetch("http://localhost/api/recover-password", {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
